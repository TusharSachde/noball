...
angular.module('phonecatControllers', ['templateservicemod', 'navigationservice', 'ui.bootstrap', 'ngSanitize', 'angular-flexslider', 'duScroll', 'cfp.loadingBar', 'ngDialog', 'angularFileUpload', 'ngSanitize', 'ui-rangeSlider', "customUI"])
    ...
    .controller('CapsCtrl', function ($scope, $filter, $state, TemplateService, NavigationService, $timeout, $stateParams, $uibModal, cfpLoadingBar) {
        //Used to name the .html file
        $scope.template = TemplateService.changecontent("caps");
        $scope.menutitle = NavigationService.makeactive("Caps");
        TemplateService.title = $scope.menutitle;
        $scope.navigation = NavigationService.getnav();
        $scope.activeButton = 1;
        $scope.toggleTab = function (val) {
        ...
        $scope.$on('$stateChangeStart', function (event, toState, fromState) {
            if (toState.name == 'capsEdit' || toState.name == 'ordersummary' || toState.name == 'savedesign') {
                window.location.reload();
            } else {
                var answer = confirm("Are you sure you want to leave this page? Your changes will not be saved.");
                if (answer) {
        ...
        $scope.capDeleteModal = function () {
            $scope.capDel = $uibModal.open({
                templateUrl: "views/modal/odi-delete.html",
                scope: $scope
            });
        }
        ...
        $scope.colorObj = $scope.capImages1;
        $scope.changeCapsImages = function (color) {
            console.log(color);
            console.log($scope.colorObj);
            var val = _.pick($scope.colorObj, color);
            console.log(val);
        ...
        $scope.openDesign1 = function (img) {
            ...
            $scope.designJson.color.base = getColor(img.color);
            $scope.colorObj = img.colorObj;
            $scope.changeCapsImages(img.color);
        };
        $scope.openDesign = function (index, tab, img) {
            console.log('*********************');
            if ($scope.LogosTab) {
        ...
        $scope.capImages1 = {
            "black": ["img/caps/front/black.png"],
            ...
            "yellow": ["img/caps/front/yellow.png"]
        };
        ...
        $scope.myArr = [{
            name: "howzat 101",
            img: $scope.capImages1.black,
            color: "black",
            id: 0,
            colorObj: $scope.capImages1
        }, {
            name: "inside edge 202",
            img: $scope.capImages3.dark_brown,
            color: "dark_brown",
            id: 1,
            colorObj: $scope.capImages3
        }, {
            name: "not out 303",
            img: $scope.capImages2.grey,
            color: "grey",
            id: 2,
            colorObj: $scope.capImages2
        }];
        ...
        $scope.capLogo = {};
        // $scope.padLogo.isTeamLogo = false;
        $scope.capLogo.divattributes = {
            top: '342px',
            left: '278px'
        };
        $scope.capLogo.attributes = {};
        $scope.capLogo.attributes.width = 100;
        $scope.capLogo.printType = 'embroidered';
        $scope.statuses = {};
        ...
        $scope.capsArrCount = 1;

        $scope.addcapsValues = function () {
            $scope.capsArr.push(_.clone($scope.caps));
            $scope.capsArrCount = $scope.capsArrCount + 1;
        }
        $scope.removecapsValue = function (index) {
            $scope.capsArr.splice(index, 1);
            $scope.capsArrCount = $scope.capsArrCount - 1;
        }
        ...
        $scope.selectCapsDesign = function (item) {
            ...
            if ($scope.Arrayname == '$scope.capImages2') {
                $scope.capLogo.divattributes = {
                    // top: '355px',
                    // left: '296px'
                    top: '340px',
        ...
        $scope.selectCapsDesign($scope.myArr[0]);
        console.log($scope.myArr[0]);
        ...
        $scope.checkloginCaps = function () {
            ...
            if ($scope.isLogin) {
                console.log('////////////');
                NavigationService.saveDesign(user.email, $scope.designJson, 'caps',
                    function (data) {
                        console.log('Save Design data: ', data);
                        // $state.go('savedesign');
                        $uibModal.open({
        ...
        $scope.capLogo = {};
        $scope.capLogo.isTeamLogo = false;
        $scope.capLogo.divattributes = {
            top: '342px',
            left: '278px'
        };
        ...
        $scope.toOrderSummary = function () {
            if (user && user.email) {
                NavigationService.orderSummaryTrouser(user.email, $scope.designJson, 'caps',
                    function (data) {
    ...
    .controller('CapsnhatsCtrl', function ($scope, $filter, $state, TemplateService, NavigationService, $timeout, $stateParams, $uibModal, cfpLoadingBar) {
        //Used to name the .html file
        ...
        $scope.myArr = [{
            ...
            name: "TRINIDAD",
            img: $scope.hatImages1.black,
            color: "black",
            id: 1,
            colorObj: $scope.hatImages1
        }];
     ...
     .controller('TravelwearCtrl', function ($scope, $filter, $state, TemplateService, NavigationService, $timeout, $stateParams, $uibModal, cfpLoadingBar) {
        ...
        $scope.$on('$stateChangeStart', function (event, toState, fromState) {
            if (toState.name == 'hoodieEdit' || toState.name == 'ordersummary' || toState.name == 'savedesign') {
                window.location.reload();
            } else {
                var answer = confirm("Are you sure you want to leave this page? Your changes will not be saved.");
                if (answer) {
        ...
        $scope.hoodieDeleteModal = function () {
            $scope.capDel = $uibModal.open({
                templateUrl: "views/modal/odi-delete.html",
                scope: $scope
            });
        ...
        $scope.confirmEmptyImage = function (key) {
            console.log('key', key);
            $scope.designJson[key] = {};
            $scope.hoodieDel.close();
        }
        $scope.emptyImage = function (key) {
            console.log('ftyghftg', key);
            $scope.saveKey = key;
            $scope.hoodieDeleteModal();
        }
        $scope.outplace = function () {
            $uibModal.open({
                templateUrl: "viewsDesign.name/modal/outofplace.html",
        ...
        $scope.colorObj = $scope.hoodieImages1;
        $scope.changeHoodieImages = function (color) {
            //console.log(color);
            //console.log($scope.colorObj);
            var val = _.pick($scope.colorObj, color);
            //console.log(val);
            $scope.hoodieColors = color;
            $scope.designJson.design.base = val[color][0];
            $scope.designJson.color.base = getColor(color);
        ...
        $scope.openDesign1 = function (img) {
            ...
            $scope.designJson.color.base = getColor(img.color);
            $scope.colorObj = img.colorObj;
            $scope.changeHoodieImages(img.color);
        };
        $scope.openDesign = function (index, tab, img) {
            //console.log('*********************');
        ...
        $scope.hoodieImages1 = {
            "black": ["img/travelwear/hoodie/front/black.png"],
        ...
        $scope.poloImages1 = {
            "black": ["img/travelwear/polo/front/black.png"],
            "cobalt_blue": ["img/travelwear/polo/front/cobalt_blue.png"],
            "grey": ["img/travelwear/polo/front/grey.png"],
            "mustard_yellow": ["img/travelwear/polo/front/mustard_yellow.png"],
        ...
        $scope.myArr = [{
            ...
            name: "Polo",
            img: $scope.poloImages1.black,
            color: "black",
            id: 3,
            colorObj: $scope.poloImages1
        }, {
            name: "Polo",
            img: $scope.poloImages1.red,
            color: "red",
            id: 4,
            colorObj: $scope.poloImages1
        }, {
            name: "Polo",
            img: $scope.poloImages1.cobalt_blue,
            color: "cobalt_blue",
            id: 5,
            colorObj: $scope.poloImages1
        }];
        ...
        $scope.addTshirtValues = function () {
            ...
            $scope.designJson.quantity.push(tempObj);
        }
        ...
        $scope.designJson.teamLogo.size = 25;
        $scope.changeLogo = function () {
            $scope.borderClass = "active-border";
        };
        $scope.resetLogoStyle = function () {
        ...
        $scope.hoodieLogo = {};
        // $scope.padLogo.isTeamLogo = false;
        $scope.hoodieLogo.divattributes = {
            top: '342px',
            left: '278px'
        };
        $scope.hoodieLogo.attributes = {};
        $scope.hoodieLogo.attributes.width = 100;
        $scope.hoodieLogo.printType = 'embroidered';
        $scope.statuses = {};
        ...
        $scope.hoodieArrCount = 1;

        $scope.addhoodieValues = function () {
            $scope.hoodieArr.push(_.clone($scope.hoodie));
            $scope.hoodieArrCount = $scope.hoodieArrCount + 1;
        }
        $scope.removehoodieValue = function (index) {
            $scope.hoodieArr.splice(index, 1);
            $scope.hoodieArrCount = $scope.hoodieArrCount - 1;
        }
        ...
        $scope.selectHoodieDesign = function (item) {
            ...
            $scope.selectedImage = item.img[0];
            console.log($scope.Arrayname);
            if ($scope.Arrayname == '$scope.hoodieImages1') {
                $scope.hoodieLogo.divattributes = {
                    // top: '343px',
                    // left: '279px'
                    top: '327px',
            ...
            if ($scope.Arrayname == '$scope.poloImages2') {
                $scope.hoodieLogo.divattributes = {
                    // top: '355px',
                    // left: '296px'
                    top: '340px',
        ...
        $scope.selectHoodieDesign($scope.myArr[0]);
        console.log($scope.myArr[0]);
        ...
        $scope.checkloginHoodie = function () {
            // if (qty == 0) {
            //     $scope.qtyValidation = true;
            // }
            if (NavigationService.getUser()) {
        ...
        $scope.hoodieLogo = {};
        $scope.hoodieLogo.isTeamLogo = false;
        $scope.hoodieLogo.divattributes = {
            top: '342px',
            left: '278px'
        };
    ...
    .controller('ShortsCtrl', function ($scope, $state, TemplateService, NavigationService, $timeout, $stateParams, $uibModal, cfpLoadingBar, $filter) {
     ...
     .controller('HatsCtrl', function ($scope, $filter, $state, TemplateService, NavigationService, $timeout, $stateParams, $uibModal, cfpLoadingBar) {
        ...
        //$scope.hatscolor=[];
        $scope.$on('$stateChangeStart', function (event, toState, fromState) {
            if (toState.name == 'hatsEdit' || toState.name == 'ordersummary' || toState.name == 'savedesign') {
                window.location.reload();
            } else {
                var answer = confirm("Are you sure you want to leave this page? Your changes will not be saved.");
                if (answer) {
        ...
        $scope.hatDeleteModal = function () {
            $scope.hatDel = $uibModal.open({
                templateUrl: "views/modal/odi-delete.html",
                scope: $scope
            });
        }
        ...
        $scope.openDesign1 = function (img) {
            ...
            $scope.designJson.color.base = getColor(img.color);
            $scope.colorObj = img.colorObj;
            $scope.changeHatsImages(img.color);
        };
        $scope.openDesign = function (index, tab, img) {
            console.log('*********************');
            if ($scope.LogosTab) {
        ...
        $scope.myArr = [{
            ...
            name: "inside edge 202",
            img: $scope.hatImages3.dark_brown,
            color: "dark_brown",
            id: 1,
            colorObj: $scope.hatImages3
        }, {
            name: "not out 303",
            img: $scope.hatImages2.grey,
            color: "grey",
            id: 2,
            colorObj: $scope.hatImages2
        }];
        ...
        $scope.hatLogo = {};
        // $scope.padLogo.isTeamLogo = false;
        $scope.hatLogo.divattributes = {
            top: '342px',
            left: '278px'
        };
        $scope.hatLogo.attributes = {};
        $scope.hatLogo.attributes.width = 100;
        $scope.hatLogo.printType = 'embroidered';
        $scope.statuses = {};
        ...
        $scope.hatsArrCount = 1;

        $scope.addhatsValues = function () {
            $scope.hatsArr.push(_.clone($scope.hats));
            $scope.hatsArrCount = $scope.hatsArrCount + 1;
        }
        $scope.removehatsValue = function (index) {
            $scope.hatsArr.splice(index, 1);
            $scope.hatsArrCount = $scope.hatsArrCount - 1;
        }
        ...
        $scope.selectHatsDesign = function (item) {
            console.log(item);
            $scope.hatsDesign.name = item.name;
            $scope.hatsDesign.image = item.img[0];
            $scope.Arrayname = item.name;
            $scope.selectedImage = item.img[0];
            console.log($scope.Arrayname);
            if ($scope.Arrayname == '$scope.hatImages1') {
                $scope.hatLogo.divattributes = {
                    // top: '343px',
                    // left: '279px'
                    top: '327px',
        ...
        $scope.selectHatsDesign($scope.myArr[0]);
        console.log($scope.myArr[0]);
        ...
        $scope.selectHatImage = function (image) {
            console.log(image);
            $scope.selectedImage = {
                image: image
            }
        ...
        $scope.checkloginHats = function () {
            ...
            if ($scope.isLogin) {
                console.log('////////////');
                NavigationService.saveDesign(user.email, $scope.designJson, 'hats',
                    function (data) {
                        console.log('Save Design data: ', data);
                        // $state.go('savedesign');
                        $uibModal.open({
        ...
        $scope.hatLogo = {};
        $scope.hatLogo.isTeamLogo = false;
        $scope.hatLogo.divattributes = {
            top: '342px',
            left: '278px'
        };
        ...
        $scope.toOrderSummary = function () {
            if (user && user.email) {
                NavigationService.orderSummaryTrouser(user.email, $scope.designJson, 'hats',
                    function (data) {
                        console.log('Order Summary hats data: ', data);
                        $state.go('ordersummary', {
                            id: data.id
                        });
                    },
    ...
    .controller('KitbagsCtrl', function ($scope, $filter, $state, TemplateService, NavigationService, $timeout, $stateParams, $uibModal, cfpLoadingBar) {
        ...
        $scope.$on('$stateChangeStart', function (event, toState, fromState) {
            if (toState.name == 'kitbagsEdit' || toState.name == 'ordersummary' || toState.name == 'savedesign') {
                window.location.reload();
            } else {
                var answer = confirm("Are you sure you want to leave this page? Your changes will not be saved.");
                if (answer) {
        ...
        $scope.confirmEmptyImage = function (key) {
            console.log('key', key);
            $scope.designJson[key] = {};
            $scope.kitbagDel.close();
        }
        $scope.emptyImage = function (key) {
            console.log('ftyghftg', key);
            $scope.saveKey = key;
            $scope.kitbagDeleteModal();
        }
        $scope.outplace = function () {
            $uibModal.open({
                templateUrl: "views/modal/outofplace.html",
        ...
        $scope.openDesign1 = function (img) {
            ...
            $scope.designJson.color.base = getColor(img.color);
            $scope.colorObj = img.colorObj;
            $scope.changeKitbagsImages(img.color);
        };
        $scope.openDesign = function (index, tab, img) {
            console.log('*********************');
            if ($scope.LogosTab) {
        ...
        $scope.kitbagImages1 = {
            "dgreen": ["img/kitbag/big/kitbag_bglg.png"],
            "dgreeno": ["img/kitbag/big/kitbag_bgy.png"],
            "black": ["img/kitbag/big/kitbag_blg.png"],
            "green": ["img/kitbag/big/kitbag_dglg.png"],
            "greeno": ["img/kitbag/big/kitbag_dgy.png"],
            "dpink": ["img/kitbag/big/kitbag_mlg.png"],
            "dpinko": ["img/kitbag/big/kitbag_my.png"],
            "dblue": ["img/kitbag/big/kitbag_rbr.png"],
            "navyblue": ["img/kitbag/big/kitbag_rby.png"],
            "red": ["img/kitbag/big/kitbag_ry.png"]
        };
        ...
        $scope.myArr = [{
            name: "howzat 101",
            img: $scope.kitbagImages1.dgreen,
            color: "dgreen",
            id: 0,
            colorObj: $scope.kitbagImages1
        }, {
            name: "inside edge",
            img: $scope.kitbagImages3.dblue,
            color: "dblue",
            id: 1,
            colorObj: $scope.kitbagImages3
        }, {
            name: "not out 303",
            img: $scope.kitbagImages2.red,
            color: "red",
            id: 2,
            colorObj: $scope.kitbagImages2
        }];
        ...
        $scope.kitbagLogo = {};
        // $scope.padLogo.isTeamLogo = false;
        $scope.kitbagLogo.divattributes = {
            top: '342px',
            left: '278px'
        };
        $scope.kitbagLogo.attributes = {};
        $scope.kitbagLogo.attributes.width = 100;
        $scope.kitbagLogo.printType = 'embroidered';
        $scope.statuses = {};
        ...
        $scope.kitbagsArrCount = 1;

        $scope.addkitbagsValues = function () {
            $scope.kitbagsArr.push(_.clone($scope.kitbags));
            $scope.kitbagsArrCount = $scope.kitbagsArrCount + 1;
        }
        $scope.removekitbagsValue = function (index) {
            $scope.kitbagsArr.splice(index, 1);
            $scope.kitbagsArrCount = $scope.kitbagsArrCount - 1;
        }
        ...
        $scope.selectKitbagsDesign = function (item) {
            console.log(item);
            $scope.kitbagsDesign.name = item.name;
            $scope.kitbagsDesign.image = item.img[0];
            $scope.Arrayname = item.name;
            $scope.selectedImage = item.img[0];
            console.log($scope.Arrayname);
            if ($scope.Arrayname == '$scope.kitbagImages1') {
                $scope.kitbagLogo.divattributes = {
                    // top: '343px',
                    // left: '279px'
                    top: '327px',
            ...
            if ($scope.Arrayname == '$scope.kitbagImages2') {
                $scope.kitbagLogo.divattributes = {
                    // top: '355px',
                    // left: '296px'
                    top: '340px',
        ...
        $scope.selectKitbagsDesign($scope.myArr[0]);
        console.log($scope.myArr[0]);
        ...
        $scope.checkloginKitbags = function () {
            // if (qty == 0) {
            //     $scope.qtyValidation = true;
            // }
            if (NavigationService.getUser()) {
        ...
        $scope.kitbagLogo = {};
        $scope.kitbagLogo.isTeamLogo = false;
        $scope.kitbagLogo.divattributes = {
            top: '342px',
            left: '278px'
        };
        ...
        $scope.toOrderSummary = function () {
            if (user && user.email) {
                NavigationService.orderSummaryKitbags(user.email, $scope.designJson, 'kitbags',
                    function (data) {
                        console.log('Order Summary kitbags data: ', data);
                        $state.go('ordersummary', {
                            id: data.id
                        });
                    },
    ...
    .controller('KitBagCtrl', function ($scope, $state, TemplateService, NavigationService, $timeout, $uibModal, cfpLoadingBar) {
        ...
        $scope.toOrderSummary = function () {
            ...
            console.log($scope.lastJSON);
            if (user && user.email) {
                NavigationService.orderSummaryKitbags(user.email, $scope.combineJSON, 'kitbags',
                    function (data) {
                        console.log('Order Summary kitbags data: ', data);
                        $state.go('ordersummary', {
                            id: data.id
    ...
    .controller('Kitbags1Ctrl', function ($scope, $filter, $state, TemplateService, NavigationService, $timeout, $stateParams, $uibModal, cfpLoadingBar) {
        //Used to name the .html file
        $scope.template = TemplateService.changecontent("kit-bags");
        $scope.menutitle = NavigationService.makeactive("Kitbags");
        TemplateService.title = $scope.menutitle;
        $scope.navigation = NavigationService.getnav();
        $scope.activeButton = 1;
	...
	/*$scope.bagsArr = [{
       ...
       // $scope.designJson.quantity = $scope.bagsArr;
        ...
        $scope.colorObj = $scope.kitbagImages1;
        $scope.changekitbagImages = function (color) {
            //console.log(color);
            //console.log($scope.colorObj);
            var val = _.pick($scope.colorObj, color);
            //console.log(val);
        ...
        $scope.openDesign1 = function (img) {
            ...
            $scope.designJson.color.base = getColor(img.color);
            $scope.colorObj = img.colorObj;
            $scope.changekitbagImages(img.color);
        };
        $scope.openDesign = function (index, tab, img) {
            //console.log('*********************');
            if(index==0 || index==1 || index==2)
        ...
        $scope.kitbagImages1 = {
            "ry": ["img/kitbag/big/kitbag_ry.png"],
            "bglg": ["img/kitbag/big/kitbag_bglg.png"],
            "bgy": ["img/kitbag/big/kitbag_bgy.png"],
            "blg": ["img/kitbag/big/kitbag_blg.png"],
       ...
       $scope.switchTrimBase = function (color) {
        ...
        $scope.kitbagArrCount = 1;

        $scope.addkitbagValues = function () {
            $scope.kitbagArr.push(_.clone($scope.kitbag));
            $scope.kitbagArrCount = $scope.kitbagArrCount + 1;
        }
        $scope.removekitbagValue = function (index) {
            $scope.kitbagArr.splice(index, 1);
            $scope.kitbagArrCount = $scope.kitbagArrCount - 1;
        }
       ...
       /* $scope.addQuantity = function (q) {
        ...
        $scope.selectkitbagDesign($scope.myArr[0]);
        console.log($scope.myArr[0]);
        ...
        $scope.selectkitbagImage = function (image) {
            console.log(image);
            $scope.selectedImage = {
                image: image
            }
    ...
    .controller('BatCtrlOld', function ($scope, $state, TemplateService, NavigationService, $timeout, $uibModal) {
        //Used to name the .html file
    ...
    .controller('BatCtrl', function ($scope, $filter, $state, TemplateService, NavigationService, $timeout, $stateParams, $uibModal, cfpLoadingBar) {
        ...
        $scope.menutitle = NavigationService.makeactive("Bats");
        TemplateService.title = $scope.menutitle;
        $scope.navigation = NavigationService.getnav();
        $scope.activeButton = 1;
        $scope.toggleTab = function (val) {
        ...
        $scope.$on('$stateChangeStart', function (event, toState, fromState) {
            if (toState.name == 'batsEdit' || toState.name == 'ordersummary' || toState.name == 'savedesign') {
                window.location.reload();
            } else {
                var answer = confirm("Are you sure you want to leave this page? Your changes will not be saved.");
                if (answer) {
        ...
        $scope.batDeleteModal = function () {
            $scope.batDel = $uibModal.open({
                templateUrl: "views/modal/odi-delete.html",
                scope: $scope
            });
        }
        ...
        $scope.openDesign1 = function (img) {
            ...
            $scope.designJson.color.base = getColor(img.color);
            $scope.colorObj = img.colorObj;
            $scope.changebatsImages(img.color);
        };
        $scope.openDesign = function (index, tab, img) {
            //console.log('*********************');
            if(index==0)
        ...
        $scope.myArr = [{
            name: "VIKINGS",
            img: $scope.batImages1.orange,
            color: "orange",
            id: 0,
            colorObj: $scope.batImages1
        }];
        ...
        $scope.batsArrCount = 1;

        $scope.addbatsValues = function () {
            $scope.batsArr.push(_.clone($scope.bats));
            $scope.batsArrCount = $scope.batsArrCount + 1;
        }
        $scope.removebatsValue = function (index) {
            $scope.batsArr.splice(index, 1);
            $scope.batsArrCount = $scope.batsArrCount - 1;
        }
        ...
        $scope.batLogo = {};
        $scope.batLogo.isTeamLogo = false;
        $scope.batLogo.divattributes = {
            top: '342px',
            left: '278px'
        };
        $scope.batLogo.attributes = {};
        $scope.batLogo.attributes.width = 100;
        $scope.batLogo.printType = 'embroidered';
        $scope.statuses = {};
    ...
    .controller('CheckoutCtrl', function ($scope, $state, TemplateService, NavigationService, $timeout, $interval, cfpLoadingBar, $uibModal, $window) {
        ...
        if ($scope.user) {
            ...
            } else if ($scope.latestOrder.description.designType === 'caps') {
