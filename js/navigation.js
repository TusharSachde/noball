...
var navigationservice = angular.module('navigationservice', [])
  ...
  .factory('NavigationService', function ($http, $state, $rootScope) {
    ...
    return {
      ...
      orderSummaryballs: function (user, jsonData, type, callback, err) {
        jsonData.currencyCountry = $.jStorage.get('getCountry');
        var myData = {
          "email": user,
          "description": jsonData,
      ...
      orderSummarybats: function (user, jsonData, type, callback, err) {
        jsonData.currencyCountry = $.jStorage.get('getCountry');
        var myData = {
          "email": user,
          "description": jsonData,
      ...
      checkoutForm: function (data, callback, err) {
        return $http({
          url: adminurl + "saveCustomOrderEnquiry",
          method: "POST",
          data: data
        }).success(callback);
      },
      ...
      saveAllOrder: function (user, jsonData, callback, err) {
        var myData = {
          "email": user,
          "description": jsonData
        };
      ...
      setCheckout: function (checkout, callback) {
        console.log('checkoutNAvi', checkout);
        return $http({
